...
class SemSegFPNHead(nn.Module):
    ...
    def forward(self, features, targets=None):
        ...
        sem_seg_features = self.layers(features)
        if self.training:
            return None, self.losses(sem_seg_features, targets)
        else:
            x = F.interpolate(
                sem_seg_features, scale_factor=self.common_stride, mode="bilinear", align_corners=False
            )
            return x, {}, sem_seg_features
