...
class StandardROIHeads(ROIHeads):
    ...
    def forward(
        ...
        if self.training:
            ...
            pred_instances, mask_features = self.forward_with_given_boxes(features, pred_instances)
            return pred_instances, {}, box_features, mask_features
    ...
    def _forward_box(self, features: Dict[str, torch.Tensor], proposals: List[Instances]):
        ...
        if self.training:
            ...
            return pred_instances, box_features[filter_inds]
    ...
    def _forward_mask(self, features: Dict[str, torch.Tensor], instances: List[Instances]):
        ...
        if self.training:
            ...
            return self.mask_head(features, instances), features
